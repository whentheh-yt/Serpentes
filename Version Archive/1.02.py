...
ENEMY_AURA_COLOR = "#ff9999"  # lighter red around enemy
ENEMY_AURA_PAD = 4             # pixels around the cell
...
# -- Score Window Configuration --
SCORE_WINDOW_WIDTH = 200
SCORE_WINDOW_HEIGHT = 100
SCORE_UPDATE_MS = 100  # update interval
SCORE_BG_COLOR = "#44484f"
SCORE_FG_COLOR = "#ffffff"
SCORE_FONT = ("Segoe UI", 24, "bold")
